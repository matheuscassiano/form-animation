...
Repositorio feito com base na video aula da Rocketseat sobre animação com CSS3 e JS puros - sem utilizar frameworks, [Repositorio original](https://github.com/Rocketseat/youtube-form-animate-css-js-puro) [Link para à aula](https://www.youtube.com/watch?v=GykTLqODQuU). [Resultado final aqui](https://matheuscassiano.github.io/form-animation/)
